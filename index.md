...
You can also jump straight to my [Current Projects](#current-projects) or check out my [Goals for this Year](#goals-for-this-year).
...
## My Developer Setup <a id ="my-setup"></a>
I spend a lot of time working across different environments. Here are a few tools I use *all the time*:
* GitHub for version control
* AWS for cloud hosting
* Leetcode and HackerRank to advance my skills


## Current Projects <a id="current-projects"></a>
